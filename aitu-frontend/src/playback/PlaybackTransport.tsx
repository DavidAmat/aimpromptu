/** Play, restart, and jump to a time. Shared by both animated views. */
...
export function PlaybackTransport({ playback }: { playback: PlaybackController }) {
  ...
  return (
    ...
    >
      ...
      {/*
        The position used to read "frame 412 · 00:16.48". There is no frame here:
        a column length is a drawing choice on the Rhythm step and it has no
        business naming a moment in a recording.
      */}
