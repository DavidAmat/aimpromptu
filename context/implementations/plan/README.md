...
Current boundary, 2026-08-13: **Epics 1–9 are done** (Stories 9.1–9.6 were built, then partly
replaced by the wall-clock refactor; Story 9.7's remaining trill detection landed 2026-08-13).
The live backlog is Epics 10–14, all rewritten for the new model. Read
